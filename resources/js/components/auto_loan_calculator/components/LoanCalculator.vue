...
export default {
    ...
    data(){
        return {
            carPrice: 25000, // giá xe
            downPayment: 5000, // tiền đặt cọc
            monthlyPayment: 0, // thanh toán hằng tháng
            interestRate: 3, // lãi suất
            interestTotal: 0, // tiền lãi tổng cộng
            duration: 60, // thời hạn
            isYearly: false,
            ...
            headers: [
                    ...
                    { label: "Interest" },  // tiền lãi
                    { label: "Total Interest" }, // tổng tiền lãi
                    { label: "Balance" }
                    ],
            amortizationList: [] // Danh sách khấu hao 
        }
    },
    computed: {
        principalTotal() {
